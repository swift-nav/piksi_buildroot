...
PIKSI_SYSTEM_DAEMON_INSTALL_STAGING = YES

PIKSI_SYSTEM_DAEMON_CFLAGS :=

ifdef BR2_BUILD_STARLING_DAEMON
PIKSI_SYSTEM_DAEMON_CFLAGS += -DPBR_BUILD_STARLING_DAEMON
endif

define PIKSI_SYSTEM_DAEMON_BUILD_CMDS
  CFLAGS="$(TARGET_CFLAGS) $(PIKSI_SYSTEM_DAEMON_CFLAGS)" LDFLAGS="$(TARGET_LDFLAGS)" \
