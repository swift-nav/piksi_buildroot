...
are routed to the firmware: `ipc:///tmp/tmp.43080` and `ipc:///tmp/tmp.43081`,
...
endpoint_adapter --file /var/run/skylark/upload -s ipc:///tmp/tmp.43070
endpoint_adapter --file /var/run/skylark/download -p ipc:///tmp/tmp.43071
```
